...
<mj-body>
  ...
  <mj-section background-color="#fafafa">
    <mj-column width="400px">
      ...
      <mj-text color="#525252">Suite à votre demande de réinitialisation de mot de passe veuilliez trouver ci-joint le nouveau mot de passe pour vous connecter à votre cession. Il est recomandé de le changer le plus rapidement.</mj-text>
